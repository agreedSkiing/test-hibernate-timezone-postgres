...
public class UtcIT {
  ...
  public void getting_as_local_date_time() {
    RestAssured
      ...
      .assertThat()
      .body("withoutTimezoneField", is("2022-12-18T19:39:20"))
      .body("withTimezoneField", is("2022-12-18T18:39:20"))
      .body("withTimezoneGmt2Field", is("2022-12-18T17:39:20"));
  }
  ...
  public void getting_as_zoned_date_time() {
    RestAssured
      ...
      .statusCode(HttpURLConnection.HTTP_OK)
      .assertThat()
      .body("withoutTimezoneField", is("2022-12-18T19:39:20Z[UTC]"))
      .body("withTimezoneField", is("2022-12-18T18:39:20Z[UTC]"))
      .body("withTimezoneGmt2Field", is("2022-12-18T17:39:20Z[UTC]"));
  }
}
